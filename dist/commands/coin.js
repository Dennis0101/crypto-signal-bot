...
function isSendableChannel(ch) {
    return ch && typeof ch.send === 'function';
}
const cache = new TTLCache(CONFIG.CACHE_TTL_MS);
const cooldown = new Map();
export async function handleCoinCommand(msg, symbolArg, tfArg) {
